...
@Component({
  standalone: true,
  imports: [FilterChipIconComponent],
  template: `
...
describe('FilterChipIconComponent', () => {
  beforeEach(async () => {
  ...
  it('renders the aria-label and icon', () => {
    const fixture = TestBed.createComponent(HostComponent);
    fixture.detectChanges();

    const button = fixture.nativeElement.querySelector('button') as HTMLButtonElement;
    expect(button.getAttribute('aria-label')).toBe('Weitere Filter');
